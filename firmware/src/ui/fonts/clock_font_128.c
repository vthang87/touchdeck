 ...
 * Size: 128 px
 * Bpp: 4
 * Opts: --font .pio/libdeps/usb/lvgl/scripts/built_in_font/Montserrat-Medium.ttf --size 128 --bpp 4 --format lvgl --symbols 0123456789:- --no-compress --lv-include lvgl.h -o src/ui/fonts/clock_font_128.c
 ******************************************************************************/
...
#ifndef CLOCK_FONT_128
#define CLOCK_FONT_128 1
#endif
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x0, 0x0, 0x0, 0x0, 0x29, 0xef, 0xff, 0xea,
    ...
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x16, 0x9a, 0x97, 0x20, 0x0, 0x0, 0x0,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 193, .adv_w = 1366, .box_w = 74, .box_h = 93, .ofs_x = 6, .ofs_y = -1},
    {.bitmap_index = 3634, .adv_w = 758, .box_w = 33, .box_h = 91, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 5136, .adv_w = 1176, .box_w = 69, .box_h = 92, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 8310, .adv_w = 1171, .box_w = 68, .box_h = 92, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 11438, .adv_w = 1370, .box_w = 81, .box_h = 90, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 15083, .adv_w = 1176, .box_w = 67, .box_h = 92, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 18165, .adv_w = 1264, .box_w = 70, .box_h = 93, .ofs_x = 6, .ofs_y = -1},
    {.bitmap_index = 21420, .adv_w = 1225, .box_w = 69, .box_h = 91, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 24560, .adv_w = 1319, .box_w = 72, .box_h = 93, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 27908, .adv_w = 1264, .box_w = 70, .box_h = 93, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 31163, .adv_w = 465, .box_w = 19, .box_h = 70, .ofs_x = 5, .ofs_y = -1}
};
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t clock_font_128 = {
#else
lv_font_t clock_font_128 = {
#endif
