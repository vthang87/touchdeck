 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --font .pio/libdeps/usb/lvgl/scripts/built_in_font/Montserrat-Medium.ttf --size 72 --bpp 4 --format lvgl --symbols 0123456789:- --no-compress --lv-include lvgl.h -o src/ui/fonts/clock_font_72.c
 ******************************************************************************/
